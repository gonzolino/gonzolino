...
- [ironcore-dev/metal-operator](https://github.com/ironcore-dev/metal-operator) ([v0.6.2](https://github.com/ironcore-dev/metal-operator/releases/tag/v0.6.2), 1 day ago) - Kubernetes operator for automating bare metal server discovery and provisioning
