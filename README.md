...
- [ironcore-dev/enhancements](https://github.com/ironcore-dev/enhancements) -  (1 week ago)
...
- [gonzolino/tado-window-control](https://github.com/gonzolino/tado-window-control) ([v1.9.2](https://github.com/gonzolino/tado-window-control/releases/tag/v1.9.2), 3 days ago) - Cloud function to control the window state of a tado zone
- [rook/rook](https://github.com/rook/rook) ([v1.19.6](https://github.com/rook/rook/releases/tag/v1.19.6), 5 days ago) - Storage Orchestration for Kubernetes
- [ironcore-dev/cloud-provider-metal](https://github.com/ironcore-dev/cloud-provider-metal) ([v0.4.0](https://github.com/ironcore-dev/cloud-provider-metal/releases/tag/v0.4.0), 5 days ago) - Kubernetes cloud controller manager for the IronCore metal API
