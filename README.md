...
- [ironcore-dev/cloud-provider-metal](https://github.com/ironcore-dev/cloud-provider-metal) ([v0.2.0](https://github.com/ironcore-dev/cloud-provider-metal/releases/tag/v0.2.0), 3 days ago) - Kubernetes cloud controller manager for the IronCore metal API
- [gonzolino/tado-window-control](https://github.com/gonzolino/tado-window-control) ([v1.8.1](https://github.com/gonzolino/tado-window-control/releases/tag/v1.8.1), 5 days ago) - Cloud function to control the window state of a tado zone
- [gonzolino/gotado](https://github.com/gonzolino/gotado) ([v2.3.1](https://github.com/gonzolino/gotado/releases/tag/v2.3.1), 5 days ago) - Go client for the tado° Web API
