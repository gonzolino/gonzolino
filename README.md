...
- [kayrus/kuttle](https://github.com/kayrus/kuttle) - Kubernetes wrapper for sshuttle (5 days ago)
...
- [gonzolino/gotado](https://github.com/gonzolino/gotado) ([v0.3.0](https://github.com/gonzolino/gotado/releases/tag/v0.3.0), 2 days ago) - Go client for the tado° Web API
