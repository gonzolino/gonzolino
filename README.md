...
- [gonzolino/tado-window-control](https://github.com/gonzolino/tado-window-control) ([v1.3.0](https://github.com/gonzolino/tado-window-control/releases/tag/v1.3.0), 4 weeks ago) - Cloud function to control the window state of a tado zone
