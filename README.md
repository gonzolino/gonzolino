...
- [apple/container](https://github.com/apple/container) ([0.3.0](https://github.com/apple/container/releases/tag/0.3.0), 3 weeks ago) - A tool for creating and running Linux containers using lightweight virtual machines on a Mac. It is written in Swift, and optimized for Apple silicon. 
