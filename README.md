...
- [ironcore-dev/metal-operator](https://github.com/ironcore-dev/metal-operator) ([v0.7.1](https://github.com/ironcore-dev/metal-operator/releases/tag/v0.7.1), 3 days ago) - Kubernetes operator for automating bare metal server discovery and provisioning
- [ironcore-dev/machine-controller-manager-provider-ironcore-metal](https://github.com/ironcore-dev/machine-controller-manager-provider-ironcore-metal) ([v0.3.0](https://github.com/ironcore-dev/machine-controller-manager-provider-ironcore-metal/releases/tag/v0.3.0), 3 days ago) -  Gardener machine controller manager provider for bare metal server management
- [rook/rook](https://github.com/rook/rook) ([v1.20.6](https://github.com/rook/rook/releases/tag/v1.20.6), 1 week ago) - Storage Orchestration for Kubernetes
