...
- [rook/rook](https://github.com/rook/rook) ([v1.19.5](https://github.com/rook/rook/releases/tag/v1.19.5), 1 day ago) - Storage Orchestration for Kubernetes
- [apple/container](https://github.com/apple/container) ([0.12.0](https://github.com/apple/container/releases/tag/0.12.0), 2 days ago) - A tool for creating and running Linux containers using lightweight virtual machines on a Mac. It is written in Swift, and optimized for Apple silicon. 
- [ironcore-dev/ironcore-net](https://github.com/ironcore-dev/ironcore-net) ([v0.3.0](https://github.com/ironcore-dev/ironcore-net/releases/tag/v0.3.0), 6 days ago) - Provider specific implementation of ironcore network types
