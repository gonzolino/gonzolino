...
- [ironcore-dev/metal-operator](https://github.com/ironcore-dev/metal-operator) ([v0.6.2](https://github.com/ironcore-dev/metal-operator/releases/tag/v0.6.2), 3 days ago) - Kubernetes operator for automating bare metal server discovery and provisioning
...
- [ironcore-dev/metalbond](https://github.com/ironcore-dev/metalbond) ([v0.5.0](https://github.com/ironcore-dev/metalbond/releases/tag/v0.5.0), 1 week ago) - Route reflector for IronCore Infrastructure Overlay Network
