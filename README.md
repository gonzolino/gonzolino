...
- [ironcore-dev/kubectl-ironcore](https://github.com/ironcore-dev/kubectl-ironcore) - kubectl plugin for ironcore (3 weeks ago)
...
- [ironcore-dev/cloud-provider-metal](https://github.com/ironcore-dev/cloud-provider-metal) ([v0.2.0](https://github.com/ironcore-dev/cloud-provider-metal/releases/tag/v0.2.0), 4 weeks ago) - Kubernetes cloud controller manager for the IronCore metal API
