...
- [gonzolino/tado-window-control](https://github.com/gonzolino/tado-window-control) ([v1.4.0](https://github.com/gonzolino/tado-window-control/releases/tag/v1.4.0), 2 days ago) - Cloud function to control the window state of a tado zone
- [gonzolino/gotado](https://github.com/gonzolino/gotado) ([v2.0.1](https://github.com/gonzolino/gotado/releases/tag/v2.0.1), 3 days ago) - Go client for the tado° Web API
