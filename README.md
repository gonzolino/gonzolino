...
- [gonzolino/tado-window-control](https://github.com/gonzolino/tado-window-control) ([v1.2.1](https://github.com/gonzolino/tado-window-control/releases/tag/v1.2.1), today) - Cloud function to control the window state of a tado zone
- [gonzolino/gotado](https://github.com/gonzolino/gotado) ([v0.3.0](https://github.com/gonzolino/gotado/releases/tag/v0.3.0), 5 months ago) - Go client for the tado° Web API
