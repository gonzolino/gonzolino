...
- [gonzolino/gotado](https://github.com/gonzolino/gotado) ([v2.0.2](https://github.com/gonzolino/gotado/releases/tag/v2.0.2), 4 days ago) - Go client for the tado° Web API
- [kubevirt/cloud-provider-kubevirt](https://github.com/kubevirt/cloud-provider-kubevirt) ([v0.4.0](https://github.com/kubevirt/cloud-provider-kubevirt/releases/tag/v0.4.0), 4 weeks ago) - Kubernetes cloud-provider for KubeVirt
