...
- [rook/rook](https://github.com/rook/rook) ([v1.19.6](https://github.com/rook/rook/releases/tag/v1.19.6), 2 days ago) - Storage Orchestration for Kubernetes
- [ironcore-dev/cloud-provider-metal](https://github.com/ironcore-dev/cloud-provider-metal) ([v0.4.0](https://github.com/ironcore-dev/cloud-provider-metal/releases/tag/v0.4.0), 2 days ago) - Kubernetes cloud controller manager for the IronCore metal API
