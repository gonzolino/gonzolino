...
- [ironcore-dev/ironcore](https://github.com/ironcore-dev/ironcore) ([v0.3.0](https://github.com/ironcore-dev/ironcore/releases/tag/v0.3.0), 1 day ago) - Cloud Native Infrastructure as a Service
- [gonzolino/tado-window-control](https://github.com/gonzolino/tado-window-control) ([v1.9.0](https://github.com/gonzolino/tado-window-control/releases/tag/v1.9.0), 6 days ago) - Cloud function to control the window state of a tado zone
